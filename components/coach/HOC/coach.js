...
const withCoachAccess = (WrappedComponent) => {
  const WithCoachAccessComponent = (props) => {
  ...
  WithCoachAccessComponent.displayName = `withCoachAccess(${WrappedComponent.displayName || WrappedComponent.name || 'Component'})`;

  return WithCoachAccessComponent;
};

export default withCoachAccess;
